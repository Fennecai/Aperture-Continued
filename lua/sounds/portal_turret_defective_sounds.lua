...
local turretDefectiveChat = {
	...
	level = 60,
	sound = {
		"npc/turret_defective/sp_sabotage_factory_defect_chat01.wav",
...
local turretDryFire = {
	...
	level = 60,
	sound = {
		"npc/turret_defective/defect_dryfire01.wav",
...
local turretDefectiveActivateVO = {
	...
	level = 70,
	sound = {
		"npc/turret_defective/defect_activate01.wav",
...
local turretDetectiveAutoSearth = {
	...
	level = 75,
	sound = {
		"npc/turret_defective/defect_goodbye01.wav",
...
local turretDetectiveFaill = {
	...
	level = 75,
	sound = {
		"npc/turret_defective/finale02_turret_return_defect_fail01.wav",
