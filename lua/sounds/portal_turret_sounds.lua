...
local turretShoot = {
	...
	level = 60,
	sound = {
		"npc/turret_floor/turret_fire_4x_01.wav",
...
local turretDeployVO = {
	...
	level = 70,
	sound = {
		"npc/turret_floor/turret_deploy_1.wav",
...
local turretRetractVO = {
	...
	level = 70,
	sound = {
		"npc/turret_floor/turret_retire_1.wav",
...
local turretPickupVO = {
	...
	level = 70,
	sound = {
		"npc/turret_floor/turret_pickup_1.wav",
...
local turretLaunch = {
	...
	level = 70,
	sound = {
		"npc/turret_floor/turretlaunched01.wav",
...
local turretBurn = {
	...
	level = 60,
	sound = {
		"npc/turret/turretshotbylaser01.wav",
