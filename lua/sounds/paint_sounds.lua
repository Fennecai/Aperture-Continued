...
local bounceProp = {
	...
	level = 75,
	sound = {
		"paint/phys_bouncy_cube_lg_01.wav",
...
local playerBounce = {
	...
	level = 75,
	sound = {
		"player/paint/player_bounce_jump_paint_01.wav",
...
local paintFootsteps = {
	...
	level = 60,
	sound = {
		"player/footsteps/fs_fm_paint_01.wav",
...
local paintBounceEnter = {
	...
	level = 75,
	sound = {
		"player/paint/player_enter_jump_paint_01.wav",
...
local paintBounceExit = {
	...
	level = 75,
	sound = {
		"player/paint/player_exit_jump_paint_01.wav",
...
local paintSpeedEnter = {
	...
	level = 75,
	sound = {
		"player/paint/player_enter_speed_paint_01.wav",
...
local paintSpeedExit = {
	...
	level = 75,
	sound = {
		"player/paint/player_exit_speed_paint_01.wav",
...
local paintStickEnter = {
	...
	level = 75,
	sound = {
		"player/paint/player_enter_stick_paint_01.wav",
...
local paintStickExit = {
	...
	level = 75,
	sound = {
		"player/paint/player_exit_stick_paint_01.wav",
