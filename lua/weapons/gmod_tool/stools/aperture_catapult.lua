...
function TOOL:DrawHUD()
    ...
    for k, v in pairs(ents.FindByClass("ent_catapult")) do
        -- Draw trajectory if player holding tool
        -- if v:GetLandPoint() ~= Vector() then
        --     return
        -- end
        local startpos = v:GetPos()
