...
if CLIENT then
	...
	language.Add(
		"tool.aperture_portal_frame.desc",
		"A Portal emitter used to make a portal on the surface it is attached to."
	)
...
function TOOL.BuildCPanel(CPanel)
	...
	CPanel:AddControl(
		"PropSelect",
		{ConVar = "aperture_portal_frame_model", Models = list.Get("PortalFrameModels"), Height = 1}
	)
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_portal_frame.startenabled", Command = "aperture_portal_frame_startenabled", Help = true}
	)
	CPanel:AddControl(
		"Numpad",
		{Label = "#tool.aperture_portal_frame.enable", Command = "aperture_portal_frame_keyenable"}
	)
