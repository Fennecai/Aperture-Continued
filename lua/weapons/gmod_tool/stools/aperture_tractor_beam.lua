...
if CLIENT then
	...
	language.Add(
		"tool.aperture_tractor_beam.desc",
		"The Exursion Funnel will transport players and entities to some direction or back from it like a tractor beam; which is made of liquid esbestos."
	)
...
function TOOL.BuildCPanel(CPanel)
	...
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_tractor_beam.startenabled", Command = "aperture_tractor_beam_startenabled", Help = true}
	)
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_tractor_beam.startreversed", Command = "aperture_tractor_beam_startreversed", Help = true}
	)
	CPanel:AddControl(
		"Numpad",
		{
			Label = "#tool.aperture_tractor_beam.enable",
			Command = "aperture_tractor_beam_keyenable",
			Label2 = "#tool.aperture_tractor_beam.reverse",
			Command2 = "aperture_tractor_beam_keyreverse"
		}
	)
