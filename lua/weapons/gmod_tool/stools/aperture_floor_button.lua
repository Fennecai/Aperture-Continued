...
if CLIENT then
	...
	language.Add("tool.aperture_floor_button.desc", "Floor button that can activate other stuff when something or someone stands on it")
...
if SERVER then
	...
	duplicator.RegisterEntityClass("ent_portal_button_ball", MakePortalFloorButton, "pos", "ang", "class", "key_group", "data")
...
function TOOL.BuildCPanel(CPanel)
	...
	CPanel:AddControl("PropSelect", {Label = "#tool.aperture_floor_button.model", ConVar = "aperture_floor_button_model", Models = list.Get("PortalFloorButtonModels"), Height = 0})
