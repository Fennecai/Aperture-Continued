...
if CLIENT then
	...
	language.Add("tool.aperture_ball_launcher.startenabled.help", "The launcher will launch a pellet as soon as it is placed.")
	language.Add("tool.aperture_ball_launcher.time", "Lifetime")
	language.Add("tool.aperture_ball_launcher.time.help", "Configures how long it takes in seconds for the pellet to run out of energy and explode.")
