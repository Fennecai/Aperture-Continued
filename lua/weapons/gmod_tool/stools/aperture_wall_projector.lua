...
if CLIENT then
	...
	language.Add(
		"tool.aperture_wall_projector.desc",
		"A Hard Light Bridge is a flat, solid beam of sunlight that can be walked on while it is enabled."
	)
...
function TOOL.BuildCPanel(CPanel)
	...
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_wall_projector.startenabled", Command = "aperture_wall_projector_startenabled", Help = true}
	)
	CPanel:AddControl(
		"Numpad",
		{Label = "#tool.aperture_wall_projector.enable", Command = "aperture_wall_projector_keyenable"}
	)
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_wall_projector.toggle", Command = "aperture_wall_projector_toggle"}
	)
end
