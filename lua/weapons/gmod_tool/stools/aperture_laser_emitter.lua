...
if CLIENT then
	...
	language.Add("tool.aperture_laser_emitter.startenabled.help", "Thermal Discouragement Beam Emitter will be enabled when placed")
...
if SERVER then
	...
	duplicator.RegisterEntityClass("ent_portal_laser_emitter", MakeApertureLaserEmitter, "pos", "ang", "model", "key_enable", "startenabled", "toggle", "data")
...
function TOOL.BuildCPanel( CPanel )
	...
	CPanel:AddControl("PropSelect", {Label = "#tool.aperture_laser_emitter.model", ConVar = "aperture_laser_emitter_model", Models = list.Get("PortalLaserEmiterModels"), Height = 0})
	CPanel:AddControl("CheckBox", {Label = "#tool.aperture_laser_emitter.startenabled", Command = "aperture_laser_emitter_startenabled", Help = true})
	CPanel:AddControl("Numpad", {Label = "#tool.aperture_laser_emitter.enable", Command = "aperture_laser_emitter_keyenable"})
