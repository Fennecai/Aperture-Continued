...
if CLIENT then
	...
	language.Add(
		"tool.aperture_laser_field.desc",
		"A feild of discouragement beams that prevent the safe passage of unauthorized personnel and breakable items. and literally nobody is authorized."
	)
...
function TOOL:DrawToolScreen(width, height)
	...
	local x,
		y = surface.GetTextSize(text)
	draw.SimpleText(
		"#tool.aperture_laser_field.name",
		"CloseCaption_Bold",
		x + 20,
		y + 20,
		Color(50, 50, 50),
...
function TOOL.BuildCPanel(CPanel)
	...
	CPanel:AddControl(
		"PropSelect",
		{ConVar = "aperture_laser_field_model", Models = list.Get("PortalFizzlerModels"), Height = 1}
	)
	CPanel:AddControl(
		"CheckBox",
		{Label = "#tool.aperture_laser_field.startenabled", Command = "aperture_laser_field_startenabled", Help = true}
	)
