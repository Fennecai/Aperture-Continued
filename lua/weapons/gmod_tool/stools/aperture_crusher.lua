...
if CLIENT then
    ...
    language.Add("tool.aperture_crusher.twoside.help", "Spawn an additional crusher facing the first one from the other direction.")
...
function TOOL.BuildCPanel(CPanel)
    ...
    CPanel:AddControl("CheckBox", {Label = "#tool.aperture_crusher.toggle", Command = "aperture_crusher_toggle", Help = true})
end
